...
# https://github.com/xbmc/xbmc/archive/Gotham_alpha9.zip
# https://github.com/xbmc/xbmc/tree/Gotham_alpha11
case ${PV} in
9999)
...
*_alpha*|*_beta*|*_rc*)
	RELNAME="Gotham"
	MY_PV="${RELNAME}_${PV#*_}"
	MY_P="${PN}-${MY_PV}"
	SRC_URI="https://github.com/xbmc/xbmc/archive/${MY_PV}.zip -> ${P}.zip"
